    ...
    <body>
        ...
        <div class="main-wrapper box-shadow">
            <header class="clearfix">
                ...
                <div class="header-bottom home3-bg bg-light">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                <div class="footer-widget">
                                    <div class="footer-logo mb-25">
                                        <img src="{{ asset('contents/website') }}/img/logo/3.jpg" alt="" />
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="copyright" style="display: flex; justify-content: space-between;">
                                    <span style="display: inline-block">Copyright &copy; 2021 <a href="/">Ecommerce</a> .</span>
                                    </div>
                            </div>
