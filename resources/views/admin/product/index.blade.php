                                                ...
                                                <div class="row row-cols-lg-auto g-2">
                                                    <div class="col-12 d-flex flex-wrap justify-content-end align-items-center">
                                                        <div class="position-relative mx-3">
                                                            <input type="text" class="form-control ps-5" name="query" placeholder="Search Product..." /> <span class="position-absolute top-50 product-show translate-middle-y"><i class="bx bx-search"></i></span>
                                                        </div>
                                                       <!--  <div class="row mb-3 p-2">
                                                            <div class="col-md-3">
                                                                <label for=""> Product Name</label>
                                                                <select wire:model="byProductName" class="form-control" >
